typeof navigator === "object" && (function () {
  ...
  const toTitleCase = (input = '') => input.toString().replace(/\w\S*/g, text => text.charAt(0).toUpperCase() + text.substr(1).toLowerCase());
  ...
  const controls = {
    ...
    updateSeekTooltip(event) {
      ...
      const toggle = show => toggleClass$1(this.elements.display.seekTooltip, visible, show);
  ...
  const dailymotion = {
    ...
    ready() {
      ...
      const videoId = parseId$2(source);
